                    ...
                    e.each(function () {
                        ...
                        u.data('stellar-backgroundStartingLeft')
                            ...
                            i.backgrounds.push({
                                ...
                                $offsetParent: p,
                                isFixed:
                                    'fixed' === u.css('background-attachment'),
                                horizontalOffset: e,
                                verticalOffset: r,
                ...
                if (t) {
                    var s = ' -o- -moz- -ms- -webkit- -khtml- '.split(' '),
                        e =
                            ...
                            'modernizr)',
                        n = i(
                            '<style>' + e + '{#modernizr{height:3px}}</style>',
                        ).appendTo('head'),
    ...
    (i.Isotope.settings = {
        ...
        (i.Isotope.prototype = {
            _create: function (t) {
                ...
                (this.options.getSortData = i.extend(
            ...
            _updateAnimationEngine: function () {
                var t,
                    i = this.options.animationEngine
                        .toLowerCase()
                        .replace(/[ _\-]/g, '');
                switch (i) {
                    case 'css':
            ...
            layout: function (t, i) {
                ...
                if (
                    (this['_' + s + 'Layout'](t), this.options.resizesContainer)
                ) {
            ...
            _processStyleQueue: function (t, s) {
                var e,
                    ...
                    a,
                    h =
                        this.isLaidOut && this.isUsingJQueryAnimation
                            ? 'animate'
                            : 'css',
            ...
            this.each(function () {
                ...
                return s
                    ? i.isFunction(s[t]) && '_' !== t.charAt(0)
                        ? void s[t].apply(s, e)
                        : void z(
                              "no such method '" + t + "' for isotope instance",
                          )
                    : void z(
            ...
            createLi: function () {
                ...
                if (
                    ...
                    (g.className = 'bs-title-option'),
                        ...
                        null ===
                            k.options[k.selectedIndex].getAttribute(
                                'selected',
                            ) && (g.selected = !0);
                }
                return (
                ...
                if (b || (this.options.size !== !1 && !this.sizeInfo)) {
                    ...
                    var o = h.offsetHeight,
                        ...
                        w =
                            ...
                            parseInt(
                                u ? u.paddingBottom : v.css('paddingBottom'),
                            ) +
                            parseInt(
                                u ? u.borderTopWidth : v.css('borderTopWidth'),
                            ) +
                            parseInt(
                                u
                                    ? u.borderBottomWidth
                        ...
                        x =
                            ...
                            parseInt(
                                u ? u.marginBottom : v.css('marginBottom'),
                            ) +
                            2;
    ...
    !(function (factory) {
        ...
        function init(options) {
            return (
                !options ||
                    ...
                    (void 0 === options.swipe &&
                        void 0 === options.swipeStatus) ||
        ...
        function TouchSwipe(element, options) {
            ...
            function validatePinch() {
                ...
                return (
                    hasCorrectFingerCount && hasEndPoint && hasCorrectDistance
                );
            }
            function hasPinches() {
                return !!(
                ...
                $element &&
                    (val === !0
                        ...
                        : ($element.unbind(MOVE_EV, touchMove, !1),
                          ...
                          LEAVE_EV &&
                              $element.unbind(LEAVE_EV, touchLeave, !1)),
